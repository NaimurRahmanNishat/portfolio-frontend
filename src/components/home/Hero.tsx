...
const Hero = () => {
  return (
    <section className="max-w-screen-xl container mx-auto px-4">
      <div className="flex flex-col md:flex-row items-center justify-between gap-6 md:pt-20">
        {/* Left content */}
        <div className="flex flex-col gap-6 md:w-[50%]">
          ...
          {/* name sparkles */}
          <SparklesText>
            <h1 className="text-2xl md:text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-indigo-600 via-yellow-600">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-4">
            ...
            <Link
              href={cvDownload}
              download
              className="px-6 py-3 bg-gradient-to-r from-purple-500 to-indigo-500 text-white shadow hover:shadow-lg rounded-md hover:scale-105 transition-all duration-300 flex items-center justify-center gap-2"
            >
              Download CV
...
export default memo(Hero); // unnecessary re-render রোধ করবে
