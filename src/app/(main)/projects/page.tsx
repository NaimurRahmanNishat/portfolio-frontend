...
const ProjectPage = () => {
  ...
  return (
    <main className="relative overflow-hidden">
      {/* Background Pattern - সব background elements এর জন্য pointer-events-none যোগ করুন */}
      <div className="absolute top-0 left-0 w-full h-full opacity-20 dark:opacity-20 pointer-events-none -z-10">
        <DotPattern />
      </div>
      
      {/* Decorative glowing circles - এগুলোর জন্যও pointer-events-none */}
      <div className="absolute top-[-10%] left-[-10%] w-[400px] h-[400px] bg-purple-400/30 dark:bg-purple-600/20 rounded-full blur-3xl animate-pulse pointer-events-none -z-10" />
      <div className="absolute bottom-[10%] right-[-10%] w-[400px] h-[400px] bg-pink-400/30 dark:bg-pink-600/20 rounded-full blur-3xl animate-pulse delay-700 pointer-events-none -z-10" />
      
      {/* Main Content - এটি foreground এ থাকবে */}
      <div className="relative z-10 max-w-screen-xl container mx-auto px-4 py-8">
